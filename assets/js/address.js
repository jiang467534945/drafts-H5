$.fn.sjld = function(shenfen,chengshi,quyu){
	...
	$(qyp).text(qygsmr[0]);
	$(shenfen).siblings(".sfdq_num,.csdq_num").val("0");
	$(shenfen).siblings(".sfdq_tj").val(sfgsmr[0].name);
	$(shenfen).siblings(".csdq_tj").val(csgsmr[0].name);
	$(shenfen).siblings(".qydq_tj").val(qygsmr[0]);
	//默认城市
...
/*---------------------------------------------------------------------*/
	...
	$(sfli).click(function(){
		...
		$(this).parents(shenfen).siblings(".sfdq_tj").val(dqsf);
...
if(max_kd<91){
	...
	$(csp).parents(chengshi).siblings(".csdq_tj").val(csgs[0].name);
	$(qyp).text(csgs2[0]);
	$(qyp).parents(quyu).siblings(".qydq_tj").val(csgs2[0]);
	$(chengshi).siblings('.sfdq_num').val(sfnum);
	$(qyp).parents(quyu).siblings('.csdq_num').val("0");

/*------------------*/
	$(csli).click(function(){
		var dqcs = $(this).text();

		$(csp).parents(chengshi).siblings(".csdq_tj").val(dqcs);
		var dqsf_num = $(chengshi).siblings('.sfdq_num').val();
		if(dqsf_num==""){
			dqsf_num=0;
			}
			else{
...
$(qyp).text(qygs[0]);
	$(chengshi).siblings('.csdq_num').val(csnum);
	$(qyp).parents(quyu).siblings('.qydq_tj').val(qygs[0]);
	$(this).parents('.m_zlxg2').width(kuandu);
	$(qyli).click(function(){
	var dqqy = $(this).text();
		$(quyu).find('p').text(dqqy);
		$(this).parents(quyu).siblings(".qydq_tj").val(dqqy);
...
/*---------------------------------------------------------------------*/		
	...
	$(csli).click(function(){
		...
		$(chengshi).find('p').text(dqcs);
		$(chengshi).siblings(".csdq_tj").val(dqcs);
	...
	$(chengshi).siblings(".qydq_tj").val(qygs[0]);
$(qyp).text(qygs[0]);
	$(chengshi).siblings('.csdq_num').val(csnum);
	/*------------------*/
	$(qyli).click(function(){
	var dqqy = $(this).text();
		$(quyu).find('p').text(dqqy);
		$(chengshi).siblings(".qydq_tj").val(dqcs);
		$(quyu).find('p').attr('title',dqqy);
...
$(qyli).click(function(){
	var dqqy = $(this).text();
		$(quyu).find('p').text(dqqy);
		$(quyu).siblings(".qydq_tj").val(dqqy);
		$(quyu).find('p').attr('title',dqqy);
...
/*---------------------------------------------------------------------*/
// $('.m_zlxg').click(function(){
// 	$(this).siblings('.sfdq_tj').val($(sfp).text());
// 	$(this).siblings('.csdq_tj').val($(csp).text());
// 	$(this).siblings('.qydq_tj').val($(qyp).text());
// 	})//表单传值获取
